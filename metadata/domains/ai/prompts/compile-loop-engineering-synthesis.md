...
- Requested title: Loop Engineering Synthesis
- Canonical title: Loop Engineering Synthesis
- Canonical slug: loop-engineering-synthesis
...
- Use the exact canonical title provided: Loop Engineering Synthesis
- Use the exact canonical topic slug provided: loop-engineering-synthesis
...
- Path: /Users/erickperales/Projects/knowledge_base/raw/domains/ai/articles/loop-engineering.md
...
Both products have all five now.
      ...
      Automations tab: pick project, prompt, cadence, environment; results land in a Triage inbox; /goal for run-until-done
      ...
      Sub-agents
      ideate and verify
      Subagents defined as TOML in .codex/agents/
